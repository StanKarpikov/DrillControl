...
/* Bit fields */
#define APDS9960_PON            B8(00000001)
#define APDS9960_AEN            B8(00000010)
#define APDS9960_PEN            B8(00000100)
#define APDS9960_WEN            B8(00001000)
#define APSD9960_AIEN           B8(00010000)
#define APDS9960_PIEN           B8(00100000)
#define APDS9960_GEN            B8(01000000)
#define APDS9960_GVALID         B8(00000001)
